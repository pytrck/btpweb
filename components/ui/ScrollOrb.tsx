...
export function ScrollOrb() {
  ...
  // Renders regardless of reduced-motion (deliberate brand choice). The infinite
  // glitch/jitter loops are CSS animations, which the global reduced-motion rule
  // in globals.css freezes - so reduced-motion visitors still see the orb and
  // trajectory, just without the seizure-risk stutter. Position is scroll-linked.
